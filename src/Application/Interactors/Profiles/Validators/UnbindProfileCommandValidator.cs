...
{
    public class UnbindProfileCommandValidator : AbstractValidator<UnbindProfileCommand>
    {
        public UnbindProfileCommandValidator(IUserRepository userRepository, IRoleRepository roleRepository)
        {
